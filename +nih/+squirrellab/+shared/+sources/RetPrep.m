    ...
    methods
        ...
        function obj = RetPrep()
            ...
            obj.addProperty('enucleatedBy', '', ...
                'type', PropertyType('char', 'row', {'', 'Angueyra', 'Chen', 'Kunze', 'Zhao', 'Ball', 'Li', 'Ou', 'Qiao', 'Sengupta'}), ...
            ...
            obj.addProperty('tissue', 'retina', ...
                'type', PropertyType('char', 'row', {'retina','organoid','eye','larva'}),...
                'description', 'experimental tissue');
            obj.addProperty('prep', '', ...
                'type', PropertyType('char', 'row', {'whole mount cones', 'whole mount RGCs', 'slice', 'chop', 'dissociation', 'culture', 'whole larva', ''}), ...
                'description', 'type of preparation');
            obj.addProperty('bathSolution', '', ...
                'type', PropertyType('char', 'row', {'', 'Ringer', 'AmesBicarb', 'AmesHEPES', 'HibA', 'E3'}), ...
                'description', 'The solution the tissue is bathed in during experiments');   
            obj.addProperty('storageSolution', '', ...
                'type', PropertyType('char', 'row', {'', 'Ringer', 'AmesBicarb', 'AmesHEPES', 'HibA','CustomCultureMedium', 'E3'}), ...
