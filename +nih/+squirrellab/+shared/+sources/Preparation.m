    ...
    methods
        ...
        function obj = Preparation()
            ...
            obj.addProperty('tissue', 'retina', ...
                'type', PropertyType('char', 'row', {'retina', 'pineal gland', 'larva', 'other'}),...
            ...
            obj.addProperty('bathSolution', '', ...
                'type', PropertyType('char', 'row', {'', 'AmesBicarb', 'AmesHEPES', 'HibA', 'E3', 'Ringer'}), ...
                'description', 'The solution the tissue is bathed in during experiments');   
            obj.addProperty('storageSolution', '', ...
                'type', PropertyType('char', 'row', {'', 'AmesBicarb', 'AmesHEPES', 'HibA','CustomCultureMedium', 'E3', 'Ringer'}), ...
