classdef RiekeFilterWheelDevice < symphonyui.core.Device
    ...
    methods
        function obj = RiekeFilterWheelDevice(varargin)
            
            ip = inputParser();
            ip.addParameter('comPort', 'COM11', @ischar);
            ip.addParameter('NDF', 4.0, @isnumeric);
            ip.parse(varargin{:});
            
            cobj = Symphony.Core.UnitConvertingExternalDevice('NDF Filter Wheel', 'ThorLabs', Symphony.Core.Measurement(0, symphonyui.core.Measurement.UNITLESS));
